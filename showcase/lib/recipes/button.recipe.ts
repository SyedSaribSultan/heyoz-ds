...
class ButtonRecipe extends ComponentRecipe<ButtonVariant, ButtonSize, ButtonShape> {
  readonly meta: RecipeMeta = {
    ...
    notes: [
      ...
      'White on the orange and red fills measures 3.55:1 and 4.03:1 and is correct. WCAG 2.x has no polarity term so it prefers near-black on any fill lighter than #767676; APCA reverses the verdict. These pairs are gated on APCA Lc 60. An earlier revision "fixed" this and shipped a near-black label on the destructive button.',
